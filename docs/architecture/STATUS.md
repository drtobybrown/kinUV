...
**User dispatch 2026-08-18.** Development branch is `dev`. 066-1 committed (`b4ab50f`). **066-3 merged** (`0bbdb2c`). In flight: 066-2, 066-4, 066-5. No fitter, no MAP, no 066-6 until bin N is chosen.
