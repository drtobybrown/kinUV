...
**User dispatch 2026-08-18.** Development branch is `dev` (not `cursor/two-agent-ssot`). 066-1 committed (`b4ab50f`). Workers: 066-2, 066-3, 066-4, 066-5. No fitter, no MAP, no 066-6 until bin N is chosen.
