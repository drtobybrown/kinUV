...
4. `docs/reviews/` — current handshake card only; completed cards are synthesized in `docs/PRODUCTION_RECORD.md`.
5. `PLAN.md` — active work plan. If it disagrees with an ADR, the ADR wins; fix PLAN.md in the same generation.
