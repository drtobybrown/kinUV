...
Accepted hybrid after S1. Sampler is `laplace_mh`, **not** autodiff NUTS. The closed review is summarized in [`../PRODUCTION_RECORD.md`](../PRODUCTION_RECORD.md#validation-and-benchmark-evidence). Runner: [`scripts/run_s2_coverage.py`](../../scripts/run_s2_coverage.py). Artifacts: [`docs/reviews/artifacts/2026-08-29-s2/`](../reviews/artifacts/2026-08-29-s2/).
